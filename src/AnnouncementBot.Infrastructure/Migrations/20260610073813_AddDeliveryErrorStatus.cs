...
{
    /// <inheritdoc />
    public partial class AddDeliveryErrorStatus : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdminRequests_Users_RequesterId",
                        column: x => x.RequesterId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AdminRequests_Users_ReviewedById",
                        column: x => x.ReviewedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AdminRequests_Users_TargetId",
                        column: x => x.TargetId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminCategoryAccesses", x => new { x.AdminId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_AdminCategoryAccesses_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdminCategoryAccesses_Users_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscriptions", x => new { x.UserId, x.CategoryId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Announcements_Templates_TemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryStatuses_Announcements_AnnouncementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminCategoryAccesses_CategoryId",
                table: "AdminCategoryAccesses",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminRequests_ReviewedById",
                table: "AdminRequests",
                column: "ReviewedById");

            migrationBuilder.CreateIndex(
                name: "IX_AdminRequests_TargetId",
                table: "AdminRequests",
                column: "TargetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcements_TemplateId",
                table: "Announcements",
                column: "TemplateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryStatuses_AnnouncementId",
                table: "DeliveryStatuses",
                column: "AnnouncementId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryStatuses_UserId",
                table: "DeliveryStatuses",
                column: "UserId");
